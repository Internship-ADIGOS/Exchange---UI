                    ...
                    <div className="wizard-main" id="w-vertical">
                        <div className="step-app">
                            <ul className="step-steps">
                                <li data-step-target="step1" className={`${firststep?"active":""}`} onClick={() => { setFirststep(true); setSecondstep(false); setThirdstep(false); setFourthstep(false); setFifthstep(false); setSixthstep(false); setSevenStep(false) }}><span>1</span> User Information</li>
                                <li data-step-target="step2" className={`${secondstep?"active":""}`}  onClick={() => { setFirststep(false); setSecondstep(true); setThirdstep(false); setFourthstep(false); setFifthstep(false); setSixthstep(false); setSevenStep(false) }}><span>2</span> Payments Method</li>
                                ...
                                <li data-step-target="step4" className={`${fourthstep?"active":""}`}  onClick={() => { setFirststep(false); setSecondstep(false); setThirdstep(false); setFourthstep(true); setFifthstep(false); setSixthstep(false); setSevenStep(false) }}><span>2</span> Change Password</li>
                                <li data-step-target="step5" className={`${fifthstep?"active":""}`}  onClick={() => { setFirststep(false); setSecondstep(false); setThirdstep(false); setFourthstep(false); setFifthstep(true); setSixthstep(false); setSevenStep(false) }}><span>2</span> Kyc verification</li>
                                <li data-step-target="step6" className={`${sixstep?"active":""}`}  onClick={() => { setFirststep(false); setSecondstep(false); setThirdstep(false); setFourthstep(false); setFifthstep(false); setSixthstep(true); setSevenStep(false)}}><span>2</span> Google 2fa</li>
